...
Logger.addFileSink('./results/opensim.log');
...
for m = 0:msl_set.getSize()-1
    ...
    if(strcmp(char(msl.getConcreteClassName()),"Millard2012EquilibriumMuscle"))
        ...
        FL.set_strain_at_one_norm_force(1.0);
    end
end
new_model_file = ['./inputs/' char(model.getName()) '_passive_fiber_FL.osim'];
...
forsim = ForsimTool();
forsim.set_model_file(new_model_file);
...
muscles = {'gaslat_r','gasmed_r','recfem_r','soleus_r','vasint_r','vaslat_r','vasmed_r'};
